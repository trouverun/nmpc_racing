...
class FSDSClient:
    ...
    def simGetEnvironmentData(self, vehicle_name = 'FSCar'):
        environment_state = self.client.call('simGetGroundTruthEnvironment', vehicle_name)
        return EnvironmentState.from_msgpack(environment_state)
    ...
    def simGetWheelStates(self, vehicle_name = 'FSCar'):
        wheelstates = self.client.call('simGetWheelStates', vehicle_name)
        return WheelStates.from_msgpack(wheelstates)
    ...
    def getHomeGeo(self, vehicle_name = "FSCar"):
    ...
    def getCarControls(self, vehicle_name = 'FSCar'):
        return CarControls.from_msgpack(self.client.call('getCarControls', vehicle_name))
